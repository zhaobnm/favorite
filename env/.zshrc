...
export ZSH="/home/chiz/.oh-my-zsh"
...
export LS_COLORS
CDPATH=.:~/project:/mnt/c/project
export CDPATH
export PATH="${KREW_ROOT:-$HOME/.krew}/bin:$PATH"
alias apl="ansible-playbook -i hosts --list-hosts --list-tasks setup.yaml"
alias ap="ansible-playbook -i hosts setup.yaml"
alias cpsc="rsync /home/chiz/.ssh/config /mnt/c/Users/chiz/.ssh/"
ANSIBLE_PATH=/mnt/c/project/devops/ansible/deploy
export ANSIBLE_PATH
export PATH=$PATH:/usr/local/go/bin

function lv(){
    ssh dev ls /plaso/version/server -ltr
}
